 ...
 */
import { parseId } from '@geoprotocol/grc-20';
 ...
 */
export function toInt64(value, sourceHint) {
    ...
    if (!Number.isSafeInteger(value)) {
        throw new Error(`Value ${value} is outside safe integer range${sourceHint ? ` for ${sourceHint}` : ''}. Use bigint for large integers.`);
    }
    return BigInt(value);
}
