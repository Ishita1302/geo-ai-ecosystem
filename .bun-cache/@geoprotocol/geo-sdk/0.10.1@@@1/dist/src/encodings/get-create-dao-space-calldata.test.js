...
import { daysToSeconds, getCreateDaoSpaceCalldata, MINIMUM_VOTING_DURATION, MINIMUM_VOTING_DURATION_DAYS, percentageToRatio, RATIO_BASE, toContractVotingSettings, validateIpfsUri, validateVotingSettingsInput, } from './get-create-dao-space-calldata.js';
...
describe('getCreateDaoSpaceCalldata', () => {
    const validArgs = {
        ...
        initialEditorSpaceIds: [
            ...
            '0x22345678901234567890123456789012',
            '0x32345678901234567890123456789012',
        ],
        initialMemberSpaceIds: ['0xabcdefabcdefabcdefabcdefabcdefab'],
    };
    ...
    it('should accept empty initial members', () => {
        const args = { ...validArgs, initialMemberSpaceIds: [] };
