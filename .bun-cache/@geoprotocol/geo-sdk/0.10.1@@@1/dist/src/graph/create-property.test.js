...
import { BOOLEAN, BYTES, DATA_TYPE, DATE, DATETIME, DECIMAL, EMBEDDING, FLOAT, INTEGER, NAME_PROPERTY, POINT, PROPERTY, RELATION, RELATION_VALUE_RELATIONSHIP_TYPE, SCHEDULE, TEXT, TIME, TYPES_PROPERTY, } from '../core/ids/system.js';
...
describe('createProperty', () => {
    ...
    it('creates a RELATION property with properties and relation value types', async () => {
        ...
        const propRelOp = property.ops[3];
        ...
        const valueTypeRelOp = property.ops[4];
...
//# sourceMappingURL=create-property.test.js.map