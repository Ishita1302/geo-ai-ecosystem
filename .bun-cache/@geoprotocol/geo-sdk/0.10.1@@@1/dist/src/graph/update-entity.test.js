import { EmbeddingSubType, languages } from '@geoprotocol/grc-20';
...
describe('updateEntity', () => {
    ...
    it('throws error for unsafe integer in integer value', () => {
        ...
        })).toThrow(`Value ${unsafeInteger} is outside safe integer range for \`integer\` value in \`updateEntity\`. Use bigint for large integers.`);
    });
});
