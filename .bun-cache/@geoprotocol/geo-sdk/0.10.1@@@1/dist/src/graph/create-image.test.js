...
import { DESCRIPTION_PROPERTY, IMAGE_HEIGHT_PROPERTY, IMAGE_TYPE, IMAGE_URL_PROPERTY, IMAGE_WIDTH_PROPERTY, NAME_PROPERTY, TYPES_PROPERTY, } from '../core/ids/system.js';
...
describe('createImage', () => {
    ...
    it('throws an error if the provided id is invalid', async () => {
        await expect(async () => await createImage({ id: 'invalid', url: 'http://localhost:3000/image' })).rejects.toThrow('Invalid id: "invalid" for `id` in `createImage`');
    });
...
//# sourceMappingURL=create-image.test.js.map