...
import { BLOCKS, DATA_BLOCK, DATA_SOURCE_TYPE_RELATION_TYPE, NAME_PROPERTY, QUERY_DATA_SOURCE, TYPES_PROPERTY, } from '../ids/system.js';
...
it('should generate ops for a data block entity', () => {
    ...
    const sourceTypeRelOp = blockSourceTypeOp;
    ...
    const blocksRelOp = blockRelationOp;
