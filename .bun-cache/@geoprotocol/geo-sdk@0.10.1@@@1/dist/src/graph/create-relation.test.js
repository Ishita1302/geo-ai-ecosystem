...
const isCreateRelationOp = (op) => {
    return op.type === 'createRelation';
};
const isCreateEntityOp = (op) => {
...
describe('createRelation', () => {
    ...
    it('creates a relation with entityRelations (nested relations)', () => {
        ...
        const mainRelOp = relation.ops[0];
        ...
        const nestedRelOp = relation.ops[2];
...
//# sourceMappingURL=create-relation.test.js.map