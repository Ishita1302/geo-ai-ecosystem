...
export declare const INTEGER: Id;
export declare const FLOAT: Id;
...
export declare const VIDEO_TYPE: Id;
export declare const VIDEO_URL_PROPERTY: Id;
export declare const VIDEO_RENDERABLE_TYPE: Id;
/** Data blocks */
...
export declare const VIDEO_BLOCK: Id;
...
export declare const ROLE_TYPE: Id;
...
/** Ranks */
export declare const RANK_TYPE: Id;
export declare const RANK_TYPE_PROPERTY: Id;
export declare const RANK_VOTES_RELATION_TYPE: Id;
export declare const VOTE_ORDINAL_VALUE_PROPERTY: Id;
export declare const VOTE_WEIGHTED_VALUE_PROPERTY: Id;
export declare const WORKS_AT_PROPERTY: Id;
export declare const BOUNTY_TYPE: Id;
export declare const DIFFICULTY_TYPE: Id;
export declare const DIFFICULTY_PROPERTY: Id;
export declare const EASY_DIFFICULTY: Id;
export declare const MEDIUM_DIFFICULTY: Id;
export declare const HARD_DIFFICULTY: Id;
export declare const REWARD_PROPERTY: Id;
export declare const MAX_CONTRIBUTORS_PROPERTY: Id;
export declare const ACTIVE_UNTIL_PROPERTY: Id;
export declare const INTERESTED_IN_PROPERTY: Id;
export declare const MAX_SUBMISSIONS_PER_PERSON_PROPERTY: Id;
export declare const MAINTAINER_PROPERTY: Id;
export declare const ALLOCATE_PROPERTY: Id;
/** @deprecated should not be used anymore */
export declare const CREATOR_PROPERTY: Id;
export declare const SUBMISSION_PROPERTY: Id;
export declare const MEETING_TIME_PROPERTY: Id;
export declare const COMMUNITY_CALL_TYPE: Id;
export declare const COMMUNITY_CALL_PARENT_PROPERTY: Id;
export declare const PARTICIPANTS_PROPERTY: Id;
export declare const COMMUNITY_CALL_EVENT_TYPE: Id;
export declare const CALL_RSVP_PROPERTY: Id;
